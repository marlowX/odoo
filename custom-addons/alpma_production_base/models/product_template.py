...
class ProductTemplate(models.Model):
   ...
   from .components.alpma_fields import (
       ...
       # Parametry szafek
       parametr_nogi, parametr_uchyt, parametr_drzwi, parametr_typ_formatki, parametr_typ_szafki,
       # Parametry okuć
   ...
   # === IMPORT ONCHANGE ===
   from .components.alpma_onchange import _onchange_typ_meblarski, _onchange_parametr_formatki
